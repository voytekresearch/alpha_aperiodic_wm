...
if __name__ == '__main__':
    ...
    pw_channel_offsets, t_arr = train_and_test_all_subjs('PW')

    # Decode spatial location from aperiodic exponent
    exp_channel_offsets, _ = train_and_test_all_subjs('exponent')

    # Decode spatial location from aperiodic offset
    offset_channel_offsets, _ = train_and_test_all_subjs('offset')
